export const countries = [
  ...
  { code: "BA", name: "Bosnia and Herzegovina", nationality: "Bosnian and Herzegovinian" },
  ...
  { code: "KI", name: "Kiribati", nationality: "Kiribati" },
  ...
  { code: "MM", name: "Myanmar", nationality: "Myanmar" },
  ...
  { code: "MK", name: "North Macedonia", nationality: "North Macedonian" },
  ...
  { code: "KN", name: "Saint Kitts and Nevis", nationality: "Kittitian and Nevisian" },
  ...
  { code: "TT", name: "Trinidad and Tobago", nationality: "Trinidadian and Tobagonian" },
