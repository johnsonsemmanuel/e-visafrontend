                    ...
                    {filtered.length === 0 ? (
                      ...
                      filtered.map((c) => (
                        <button
                          ...
                          className={`w-full text-left px-4 py-2.5 text-sm hover:bg-[#006B3F]/5 transition-colors flex items-center justify-between ${
                            selectedCountry === c.code ? "bg-[#006B3F]/5 text-[#006B3F] font-semibold" : "text-gray-700"
                          }`}
                        >
                          <span>{c.name}</span>
